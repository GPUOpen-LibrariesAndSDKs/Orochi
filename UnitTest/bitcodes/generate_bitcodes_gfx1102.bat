...
call hipcc --offload-arch=gfx1102 ..\moduleTestFunc.cpp -c -fgpu-rdc --cuda-device-only

call hipcc --offload-arch=gfx1102 ..\moduleTestKernel.cpp -c -fgpu-rdc --cuda-device-only
