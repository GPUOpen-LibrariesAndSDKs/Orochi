...
best_cuda_version_name = "12.9"
best_cuda_envvar = "CUDA_PATH_V12_9"
best_cuda_path_linux = "/usr/local/cuda-12.9"
best_cuda_path_windows = "C:\\Program Files\\NVIDIA GPU Computing Toolkit\\CUDA\\v12.9"
