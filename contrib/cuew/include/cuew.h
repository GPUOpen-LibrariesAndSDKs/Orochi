...
typedef CUresult CUDAAPI tcuCheckpointProcessCheckpoint(int pid, CUcheckpointCheckpointArgs * args);
typedef CUresult CUDAAPI tcuCheckpointProcessGetRestoreThreadId(int pid, int * tid);
typedef CUresult CUDAAPI tcuCheckpointProcessGetState(int pid, CUprocessState * state);
typedef CUresult CUDAAPI tcuCheckpointProcessLock(int pid, CUcheckpointLockArgs * args);
typedef CUresult CUDAAPI tcuCheckpointProcessRestore(int pid, CUcheckpointRestoreArgs * args);
typedef CUresult CUDAAPI tcuCheckpointProcessUnlock(int pid, CUcheckpointUnlockArgs * args);
...
typedef CUresult CUDAAPI tcuCtxCreate_v4(CUcontext * pctx, CUctxCreateParams * ctxCreateParams, unsigned int flags, CUdevice dev);
...
typedef CUresult CUDAAPI tcuCtxFromGreenCtx(CUcontext * pContext, CUgreenCtx hCtx);
...
typedef CUresult CUDAAPI tcuCtxGetDevResource(CUcontext hCtx, CUdevResource * resource, CUdevResourceType type);
...
typedef CUresult CUDAAPI tcuCtxRecordEvent(CUcontext hCtx, CUevent hEvent);
...
typedef CUresult CUDAAPI tcuCtxWaitEvent(CUcontext hCtx, CUevent hEvent);
...
typedef CUresult CUDAAPI tcuDevResourceGenerateDesc(CUdevResourceDesc * phDesc, CUdevResource * resources, unsigned int nbResources);
typedef CUresult CUDAAPI tcuDevSmResourceSplitByCount(CUdevResource * result, unsigned int * nbGroups, const CUdevResource * input, CUdevResource * remaining, unsigned int useFlags, unsigned int minCount);
...
typedef CUresult CUDAAPI tcuDeviceGetDevResource(CUdevice device, CUdevResource * resource, CUdevResourceType type);
...
typedef CUresult CUDAAPI tcuDeviceRegisterAsyncNotification(CUdevice device, CUasyncCallback callbackFunc, void * userData, CUasyncCallbackHandle * callback);
...
typedef CUresult CUDAAPI tcuDeviceUnregisterAsyncNotification(CUdevice device, CUasyncCallbackHandle callback);
typedef CUresult CUDAAPI tcuDriverGetVersion(int * driverVersion);
typedef CUresult CUDAAPI tcuEventCreate(CUevent * phEvent, unsigned int Flags);
typedef CUresult CUDAAPI tcuEventDestroy_v2(CUevent hEvent);
typedef CUresult CUDAAPI tcuEventElapsedTime(float * pMilliseconds, CUevent hStart, CUevent hEnd);
typedef CUresult CUDAAPI tcuEventElapsedTime_v2(float * pMilliseconds, CUevent hStart, CUevent hEnd);
...
typedef CUresult CUDAAPI tcuFuncGetName(const char ** name, CUfunction hfunc);
typedef CUresult CUDAAPI tcuFuncGetParamInfo(CUfunction func, size_t paramIndex, size_t * paramOffset, size_t * paramSize);
typedef CUresult CUDAAPI tcuFuncIsLoaded(CUfunctionLoadingState * state, CUfunction function);
typedef CUresult CUDAAPI tcuFuncLoad(CUfunction function);
...
typedef CUresult CUDAAPI tcuGraphAddDependencies_v2(CUgraph hGraph, const CUgraphNode * from, const CUgraphNode * to, const CUgraphEdgeData * edgeData, size_t numDependencies);
...
typedef CUresult CUDAAPI tcuGraphAddNode_v2(CUgraphNode * phGraphNode, CUgraph hGraph, const CUgraphNode * dependencies, const CUgraphEdgeData * dependencyData, size_t numDependencies, CUgraphNodeParams * nodeParams);
...
typedef CUresult CUDAAPI tcuGraphConditionalHandleCreate(CUgraphConditionalHandle * pHandle_out, CUgraph hGraph, CUcontext ctx, unsigned int defaultLaunchValue, unsigned int flags);
...
typedef CUresult CUDAAPI tcuGraphGetEdges_v2(CUgraph hGraph, CUgraphNode * from, CUgraphNode * to, CUgraphEdgeData * edgeData, size_t * numEdges);
...
typedef CUresult CUDAAPI tcuGraphNodeGetDependencies_v2(CUgraphNode hNode, CUgraphNode * dependencies, CUgraphEdgeData * edgeData, size_t * numDependencies);
...
typedef CUresult CUDAAPI tcuGraphNodeGetDependentNodes_v2(CUgraphNode hNode, CUgraphNode * dependentNodes, CUgraphEdgeData * edgeData, size_t * numDependentNodes);
...
typedef CUresult CUDAAPI tcuGraphRemoveDependencies_v2(CUgraph hGraph, const CUgraphNode * from, const CUgraphNode * to, const CUgraphEdgeData * edgeData, size_t numDependencies);
...
typedef CUresult CUDAAPI tcuGreenCtxCreate(CUgreenCtx * phCtx, CUdevResourceDesc desc, CUdevice dev, unsigned int flags);
typedef CUresult CUDAAPI tcuGreenCtxDestroy(CUgreenCtx hCtx);
typedef CUresult CUDAAPI tcuGreenCtxGetDevResource(CUgreenCtx hCtx, CUdevResource * resource, CUdevResourceType type);
typedef CUresult CUDAAPI tcuGreenCtxRecordEvent(CUgreenCtx hCtx, CUevent hEvent);
typedef CUresult CUDAAPI tcuGreenCtxStreamCreate(CUstream * phStream, CUgreenCtx greenCtx, unsigned int flags, int priority);
typedef CUresult CUDAAPI tcuGreenCtxWaitEvent(CUgreenCtx hCtx, CUevent hEvent);
...
typedef CUresult CUDAAPI tcuKernelGetLibrary(CUlibrary * pLib, CUkernel kernel);
typedef CUresult CUDAAPI tcuKernelGetName(const char ** name, CUkernel hfunc);
typedef CUresult CUDAAPI tcuKernelGetParamInfo(CUkernel kernel, size_t paramIndex, size_t * paramOffset, size_t * paramSize);
...
typedef CUresult CUDAAPI tcuLibraryEnumerateKernels(CUkernel * kernels, unsigned int numKernels, CUlibrary lib);
...
typedef CUresult CUDAAPI tcuLibraryGetKernelCount(unsigned int * count, CUlibrary lib);
...
typedef CUresult CUDAAPI tcuLogsCurrent(CUlogIterator * iterator_out, unsigned int flags);
typedef CUresult CUDAAPI tcuLogsDumpToFile(CUlogIterator * iterator, const char * pathToFile, unsigned int flags);
typedef CUresult CUDAAPI tcuLogsDumpToMemory(CUlogIterator * iterator, char * buffer, size_t * size, unsigned int flags);
typedef CUresult CUDAAPI tcuLogsRegisterCallback(CUlogsCallback callbackFunc, void * userData, CUlogsCallbackHandle * callback_out);
typedef CUresult CUDAAPI tcuLogsUnregisterCallback(CUlogsCallbackHandle callback);
...
typedef CUresult CUDAAPI tcuMemBatchDecompressAsync(CUmemDecompressParams * paramsArray, size_t count, unsigned int flags, size_t * errorIndex, CUstream stream);
...
typedef CUresult CUDAAPI tcuMemcpy3DBatchAsync(size_t numOps, CUDA_MEMCPY3D_BATCH_OP * opList, size_t * failIdx, unsigned long long flags, CUstream hStream);
...
typedef CUresult CUDAAPI tcuMemcpyBatchAsync(CUdeviceptr * dsts, CUdeviceptr * srcs, size_t * sizes, size_t count, CUmemcpyAttributes * attrs, size_t * attrsIdxs, size_t numAttrs, size_t * failIdx, CUstream hStream);
...
typedef CUresult CUDAAPI tcuModuleEnumerateFunctions(CUfunction * functions, unsigned int numFunctions, CUmodule mod);
typedef CUresult CUDAAPI tcuModuleGetFunction(CUfunction * hfunc, CUmodule hmod, const char * name);
typedef CUresult CUDAAPI tcuModuleGetFunctionCount(unsigned int * count, CUmodule mod);
...
typedef CUresult CUDAAPI tcuStreamBeginCaptureToGraph(CUstream hStream, CUgraph hGraph, const CUgraphNode * dependencies, const CUgraphEdgeData * dependencyData, size_t numDependencies, CUstreamCaptureMode mode);
...
typedef CUresult CUDAAPI tcuStreamGetCaptureInfo_v3(CUstream hStream, CUstreamCaptureStatus * captureStatus_out, cuuint64_t * id_out, CUgraph * graph_out, const CUgraphNode ** dependencies_out, const CUgraphEdgeData ** edgeData_out, size_t * numDependencies_out);
typedef CUresult CUDAAPI tcuStreamGetCtx(CUstream hStream, CUcontext * pctx);
typedef CUresult CUDAAPI tcuStreamGetCtx_v2(CUstream hStream, CUcontext * pCtx, CUgreenCtx * pGreenCtx);
typedef CUresult CUDAAPI tcuStreamGetDevice(CUstream hStream, CUdevice * device);
typedef CUresult CUDAAPI tcuStreamGetFlags(CUstream hStream, unsigned int * flags);
typedef CUresult CUDAAPI tcuStreamGetGreenCtx(CUstream hStream, CUgreenCtx * phCtx);
...
typedef CUresult CUDAAPI tcuStreamUpdateCaptureDependencies_v2(CUstream hStream, CUgraphNode * dependencies, const CUgraphEdgeData * dependencyData, size_t numDependencies, unsigned int flags);
...
typedef cudaError_t CUDAAPI tcudaDeviceRegisterAsyncNotification(int device, cudaAsyncCallback callbackFunc, void * userData, cudaAsyncCallbackHandle_t * callback);
...
typedef cudaError_t CUDAAPI tcudaDeviceUnregisterAsyncNotification(int device, cudaAsyncCallbackHandle_t callback);
...
typedef cudaError_t CUDAAPI tcudaEventElapsedTime_v2(float * ms, cudaEvent_t start, cudaEvent_t end);
...
typedef cudaError_t CUDAAPI tcudaFuncGetName(const char ** name, const void * func);
typedef cudaError_t CUDAAPI tcudaFuncGetParamInfo(const void * func, size_t paramIndex, size_t * paramOffset, size_t * paramSize);
...
typedef cudaError_t CUDAAPI tcudaGetDriverEntryPointByVersion(const char * symbol, void ** funcPtr, unsigned int cudaVersion, unsigned long long flags, enum cudaDriverEntryPointQueryResult * driverStatus);
...
typedef cudaError_t CUDAAPI tcudaGraphAddDependencies_v2(cudaGraph_t graph, const cudaGraphNode_t * from, const cudaGraphNode_t * to, const cudaGraphEdgeData * edgeData, size_t numDependencies);
...
typedef cudaError_t CUDAAPI tcudaGraphAddNode_v2(cudaGraphNode_t * pGraphNode, cudaGraph_t graph, const cudaGraphNode_t * pDependencies, const cudaGraphEdgeData * dependencyData, size_t numDependencies, struct cudaGraphNodeParams * nodeParams);
...
typedef cudaError_t CUDAAPI tcudaGraphConditionalHandleCreate(cudaGraphConditionalHandle * pHandle_out, cudaGraph_t graph, unsigned int defaultLaunchValue, unsigned int flags);
...
typedef cudaError_t CUDAAPI tcudaGraphGetEdges_v2(cudaGraph_t graph, cudaGraphNode_t * from, cudaGraphNode_t * to, cudaGraphEdgeData * edgeData, size_t * numEdges);
...
typedef cudaError_t CUDAAPI tcudaGraphNodeGetDependencies_v2(cudaGraphNode_t node, cudaGraphNode_t * pDependencies, cudaGraphEdgeData * edgeData, size_t * pNumDependencies);
...
typedef cudaError_t CUDAAPI tcudaGraphNodeGetDependentNodes_v2(cudaGraphNode_t node, cudaGraphNode_t * pDependentNodes, cudaGraphEdgeData * edgeData, size_t * pNumDependentNodes);
...
typedef cudaError_t CUDAAPI tcudaGraphRemoveDependencies_v2(cudaGraph_t graph, const cudaGraphNode_t * from, const cudaGraphNode_t * to, const cudaGraphEdgeData * edgeData, size_t numDependencies);
...
typedef cudaError_t CUDAAPI tcudaKernelSetAttributeForDevice(cudaKernel_t kernel, enum cudaFuncAttribute attr, int value, int device);
...
typedef cudaError_t CUDAAPI tcudaLibraryEnumerateKernels(cudaKernel_t * kernels, unsigned int numKernels, cudaLibrary_t lib);
typedef cudaError_t CUDAAPI tcudaLibraryGetGlobal(void ** dptr, size_t * bytes, cudaLibrary_t library, const char * name);
typedef cudaError_t CUDAAPI tcudaLibraryGetKernel(cudaKernel_t * pKernel, cudaLibrary_t library, const char * name);
typedef cudaError_t CUDAAPI tcudaLibraryGetKernelCount(unsigned int * count, cudaLibrary_t lib);
typedef cudaError_t CUDAAPI tcudaLibraryGetManaged(void ** dptr, size_t * bytes, cudaLibrary_t library, const char * name);
typedef cudaError_t CUDAAPI tcudaLibraryGetUnifiedFunction(void ** fptr, cudaLibrary_t library, const char * symbol);
typedef cudaError_t CUDAAPI tcudaLibraryLoadData(cudaLibrary_t * library, const void * code, enum cudaJitOption * jitOptions, void ** jitOptionsValues, unsigned int numJitOptions, enum cudaLibraryOption * libraryOptions, void ** libraryOptionValues, unsigned int numLibraryOptions);
typedef cudaError_t CUDAAPI tcudaLibraryLoadFromFile(cudaLibrary_t * library, const char * fileName, enum cudaJitOption * jitOptions, void ** jitOptionsValues, unsigned int numJitOptions, enum cudaLibraryOption * libraryOptions, void ** libraryOptionValues, unsigned int numLibraryOptions);
typedef cudaError_t CUDAAPI tcudaLibraryUnload(cudaLibrary_t library);
...
typedef cudaError_t CUDAAPI tcudaMemcpy3DBatchAsync(size_t numOps, struct cudaMemcpy3DBatchOp * opList, size_t * failIdx, unsigned long long flags, cudaStream_t stream);
...
typedef cudaError_t CUDAAPI tcudaMemcpyBatchAsync(void ** dsts, void ** srcs, size_t * sizes, size_t count, struct cudaMemcpyAttributes * attrs, size_t * attrsIdxs, size_t numAttrs, size_t * failIdx, cudaStream_t stream);
...
typedef cudaError_t CUDAAPI tcudaStreamBeginCaptureToGraph(cudaStream_t stream, cudaGraph_t graph, const cudaGraphNode_t * dependencies, const cudaGraphEdgeData * dependencyData, size_t numDependencies, enum cudaStreamCaptureMode mode);
...
typedef cudaError_t CUDAAPI tcudaStreamGetCaptureInfo_v3(cudaStream_t stream, enum cudaStreamCaptureStatus * captureStatus_out, unsigned long long * id_out, cudaGraph_t * graph_out, const cudaGraphNode_t ** dependencies_out, const cudaGraphEdgeData ** edgeData_out, size_t * numDependencies_out);
typedef cudaError_t CUDAAPI tcudaStreamGetDevice(cudaStream_t hStream, int * device);
...
typedef cudaError_t CUDAAPI tcudaStreamUpdateCaptureDependencies_v2(cudaStream_t stream, cudaGraphNode_t * dependencies, const cudaGraphEdgeData * dependencyData, size_t numDependencies, unsigned int flags);
...
typedef nvrtcResult CUDAAPI tnvrtcGetPCHCreateStatus(nvrtcProgram prog);
typedef nvrtcResult CUDAAPI tnvrtcGetPCHHeapSize(size_t * ret);
typedef nvrtcResult CUDAAPI tnvrtcGetPCHHeapSizeRequired(nvrtcProgram prog, size_t * size);
...
typedef nvrtcResult CUDAAPI tnvrtcSetFlowCallback(nvrtcProgram prog, int (*callback)(void *, void *), void * payload);
typedef nvrtcResult CUDAAPI tnvrtcSetPCHHeapSize(size_t size);
...
extern tcuCheckpointProcessCheckpoint *cuCheckpointProcessCheckpoint_oro;
extern tcuCheckpointProcessGetRestoreThreadId *cuCheckpointProcessGetRestoreThreadId_oro;
extern tcuCheckpointProcessGetState *cuCheckpointProcessGetState_oro;
extern tcuCheckpointProcessLock *cuCheckpointProcessLock_oro;
extern tcuCheckpointProcessRestore *cuCheckpointProcessRestore_oro;
extern tcuCheckpointProcessUnlock *cuCheckpointProcessUnlock_oro;
...
extern tcuCtxCreate_v4 *cuCtxCreate_v4_oro;
...
extern tcuCtxFromGreenCtx *cuCtxFromGreenCtx_oro;
...
extern tcuCtxGetDevResource *cuCtxGetDevResource_oro;
...
extern tcuCtxRecordEvent *cuCtxRecordEvent_oro;
...
extern tcuCtxWaitEvent *cuCtxWaitEvent_oro;
...
extern tcuDevResourceGenerateDesc *cuDevResourceGenerateDesc_oro;
extern tcuDevSmResourceSplitByCount *cuDevSmResourceSplitByCount_oro;
...
extern tcuDeviceGetDevResource *cuDeviceGetDevResource_oro;
...
extern tcuDeviceRegisterAsyncNotification *cuDeviceRegisterAsyncNotification_oro;
...
extern tcuDeviceUnregisterAsyncNotification *cuDeviceUnregisterAsyncNotification_oro;
...
extern tcuEventElapsedTime_v2 *cuEventElapsedTime_v2_oro;
...
extern tcuFuncGetName *cuFuncGetName_oro;
extern tcuFuncGetParamInfo *cuFuncGetParamInfo_oro;
extern tcuFuncIsLoaded *cuFuncIsLoaded_oro;
extern tcuFuncLoad *cuFuncLoad_oro;
...
extern tcuGraphAddDependencies_v2 *cuGraphAddDependencies_v2_oro;
...
extern tcuGraphAddNode_v2 *cuGraphAddNode_v2_oro;
...
extern tcuGraphConditionalHandleCreate *cuGraphConditionalHandleCreate_oro;
...
extern tcuGraphGetEdges_v2 *cuGraphGetEdges_v2_oro;
...
extern tcuGraphNodeGetDependencies_v2 *cuGraphNodeGetDependencies_v2_oro;
extern tcuGraphNodeGetDependentNodes *cuGraphNodeGetDependentNodes_oro;
extern tcuGraphNodeGetDependentNodes_v2 *cuGraphNodeGetDependentNodes_v2_oro;
...
extern tcuGraphRemoveDependencies_v2 *cuGraphRemoveDependencies_v2_oro;
...
extern tcuGreenCtxCreate *cuGreenCtxCreate_oro;
extern tcuGreenCtxDestroy *cuGreenCtxDestroy_oro;
extern tcuGreenCtxGetDevResource *cuGreenCtxGetDevResource_oro;
extern tcuGreenCtxRecordEvent *cuGreenCtxRecordEvent_oro;
extern tcuGreenCtxStreamCreate *cuGreenCtxStreamCreate_oro;
extern tcuGreenCtxWaitEvent *cuGreenCtxWaitEvent_oro;
...
extern tcuKernelGetLibrary *cuKernelGetLibrary_oro;
extern tcuKernelGetName *cuKernelGetName_oro;
extern tcuKernelGetParamInfo *cuKernelGetParamInfo_oro;
...
extern tcuLibraryEnumerateKernels *cuLibraryEnumerateKernels_oro;
extern tcuLibraryGetGlobal *cuLibraryGetGlobal_oro;
extern tcuLibraryGetKernel *cuLibraryGetKernel_oro;
extern tcuLibraryGetKernelCount *cuLibraryGetKernelCount_oro;
...
extern tcuLogsCurrent *cuLogsCurrent_oro;
extern tcuLogsDumpToFile *cuLogsDumpToFile_oro;
extern tcuLogsDumpToMemory *cuLogsDumpToMemory_oro;
extern tcuLogsRegisterCallback *cuLogsRegisterCallback_oro;
extern tcuLogsUnregisterCallback *cuLogsUnregisterCallback_oro;
...
extern tcuMemBatchDecompressAsync *cuMemBatchDecompressAsync_oro;
...
extern tcuMemcpy3DBatchAsync *cuMemcpy3DBatchAsync_oro;
...
extern tcuMemcpyBatchAsync *cuMemcpyBatchAsync_oro;
...
extern tcuModuleEnumerateFunctions *cuModuleEnumerateFunctions_oro;
extern tcuModuleGetFunction *cuModuleGetFunction_oro;
extern tcuModuleGetFunctionCount *cuModuleGetFunctionCount_oro;
...
extern tcuStreamBeginCaptureToGraph *cuStreamBeginCaptureToGraph_oro;
...
extern tcuStreamGetCaptureInfo_v3 *cuStreamGetCaptureInfo_v3_oro;
extern tcuStreamGetCtx *cuStreamGetCtx_oro;
extern tcuStreamGetCtx_v2 *cuStreamGetCtx_v2_oro;
extern tcuStreamGetDevice *cuStreamGetDevice_oro;
extern tcuStreamGetFlags *cuStreamGetFlags_oro;
extern tcuStreamGetGreenCtx *cuStreamGetGreenCtx_oro;
...
extern tcuStreamUpdateCaptureDependencies_v2 *cuStreamUpdateCaptureDependencies_v2_oro;
...
extern tcuTensorMapEncodeIm2colWide *cuTensorMapEncodeIm2colWide_oro;
...
extern tcudaDeviceRegisterAsyncNotification *cudaDeviceRegisterAsyncNotification_oro;
...
extern tcudaDeviceUnregisterAsyncNotification *cudaDeviceUnregisterAsyncNotification_oro;
...
extern tcudaEventElapsedTime_v2 *cudaEventElapsedTime_v2_oro;
...
extern tcudaFuncGetName *cudaFuncGetName_oro;
extern tcudaFuncGetParamInfo *cudaFuncGetParamInfo_oro;
...
extern tcudaGetDriverEntryPointByVersion *cudaGetDriverEntryPointByVersion_oro;
...
extern tcudaGraphAddDependencies_v2 *cudaGraphAddDependencies_v2_oro;
...
extern tcudaGraphAddNode_v2 *cudaGraphAddNode_v2_oro;
extern tcudaGraphChildGraphNodeGetGraph *cudaGraphChildGraphNodeGetGraph_oro;
extern tcudaGraphClone *cudaGraphClone_oro;
extern tcudaGraphConditionalHandleCreate *cudaGraphConditionalHandleCreate_oro;
...
extern tcudaGraphGetEdges_v2 *cudaGraphGetEdges_v2_oro;
...
extern tcudaGraphNodeGetDependencies_v2 *cudaGraphNodeGetDependencies_v2_oro;
extern tcudaGraphNodeGetDependentNodes *cudaGraphNodeGetDependentNodes_oro;
extern tcudaGraphNodeGetDependentNodes_v2 *cudaGraphNodeGetDependentNodes_v2_oro;
...
extern tcudaGraphRemoveDependencies_v2 *cudaGraphRemoveDependencies_v2_oro;
...
extern tcudaKernelSetAttributeForDevice *cudaKernelSetAttributeForDevice_oro;
...
extern tcudaLibraryEnumerateKernels *cudaLibraryEnumerateKernels_oro;
extern tcudaLibraryGetGlobal *cudaLibraryGetGlobal_oro;
extern tcudaLibraryGetKernel *cudaLibraryGetKernel_oro;
extern tcudaLibraryGetKernelCount *cudaLibraryGetKernelCount_oro;
extern tcudaLibraryGetManaged *cudaLibraryGetManaged_oro;
extern tcudaLibraryGetUnifiedFunction *cudaLibraryGetUnifiedFunction_oro;
extern tcudaLibraryLoadData *cudaLibraryLoadData_oro;
extern tcudaLibraryLoadFromFile *cudaLibraryLoadFromFile_oro;
extern tcudaLibraryUnload *cudaLibraryUnload_oro;
...
extern tcudaMemcpy3DBatchAsync *cudaMemcpy3DBatchAsync_oro;
...
extern tcudaMemcpyBatchAsync *cudaMemcpyBatchAsync_oro;
...
extern tcudaStreamBeginCaptureToGraph *cudaStreamBeginCaptureToGraph_oro;
...
extern tcudaStreamGetCaptureInfo_v3 *cudaStreamGetCaptureInfo_v3_oro;
extern tcudaStreamGetDevice *cudaStreamGetDevice_oro;
...
extern tcudaStreamUpdateCaptureDependencies_v2 *cudaStreamUpdateCaptureDependencies_v2_oro;
...
extern tnvrtcGetPCHCreateStatus *nvrtcGetPCHCreateStatus_oro;
extern tnvrtcGetPCHHeapSize *nvrtcGetPCHHeapSize_oro;
extern tnvrtcGetPCHHeapSizeRequired *nvrtcGetPCHHeapSizeRequired_oro;
...
extern tnvrtcSetFlowCallback *nvrtcSetFlowCallback_oro;
extern tnvrtcSetPCHHeapSize *nvrtcSetPCHHeapSize_oro;
