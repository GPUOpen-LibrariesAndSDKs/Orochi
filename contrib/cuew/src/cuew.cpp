...
static_assert(  ((int)CUDART_VERSION / (int)1000) >= 12 && ((int)CUDART_VERSION / (int)1000) <= 13  );
#endif
...
tcudaGLGetDevices *cudaGLGetDevices_oro = nullptr;
...
_LIBRARY_FIND( cudart_lib, cudaGLGetDevices );
