...
typedef char1 HIPAPI tmake_char1(signed char x);
typedef char2 HIPAPI tmake_char2(signed char x, signed char y);
typedef char3 HIPAPI tmake_char3(signed char x, signed char y, signed char z);
typedef char4 HIPAPI tmake_char4(signed char x, signed char y, signed char z, signed char w);
typedef double1 HIPAPI tmake_double1(double x);
typedef double2 HIPAPI tmake_double2(double x, double y);
typedef double3 HIPAPI tmake_double3(double x, double y, double z);
typedef double4 HIPAPI tmake_double4(double x, double y, double z, double w);
typedef float1 HIPAPI tmake_float1(float x);
typedef float2 HIPAPI tmake_float2(float x, float y);
typedef float3 HIPAPI tmake_float3(float x, float y, float z);
typedef float4 HIPAPI tmake_float4(float x, float y, float z, float w);
...
typedef int1 HIPAPI tmake_int1(int x);
typedef int2 HIPAPI tmake_int2(int x, int y);
typedef int3 HIPAPI tmake_int3(int x, int y, int z);
typedef int4 HIPAPI tmake_int4(int x, int y, int z, int w);
typedef long1 HIPAPI tmake_long1(long x);
typedef long2 HIPAPI tmake_long2(long x, long y);
typedef long3 HIPAPI tmake_long3(long x, long y, long z);
typedef long4 HIPAPI tmake_long4(long x, long y, long z, long w);
typedef longlong1 HIPAPI tmake_longlong1(long long x);
typedef longlong2 HIPAPI tmake_longlong2(long long x, long long y);
typedef longlong3 HIPAPI tmake_longlong3(long long x, long long y, long long z);
typedef longlong4 HIPAPI tmake_longlong4(long long x, long long y, long long z, long long w);
typedef short1 HIPAPI tmake_short1(short x);
typedef short2 HIPAPI tmake_short2(short x, short y);
typedef short3 HIPAPI tmake_short3(short x, short y, short z);
typedef short4 HIPAPI tmake_short4(short x, short y, short z, short w);
typedef uchar1 HIPAPI tmake_uchar1(unsigned char x);
typedef uchar2 HIPAPI tmake_uchar2(unsigned char x, unsigned char y);
typedef uchar3 HIPAPI tmake_uchar3(unsigned char x, unsigned char y, unsigned char z);
typedef uchar4 HIPAPI tmake_uchar4(unsigned char x, unsigned char y, unsigned char z, unsigned char w);
typedef uint1 HIPAPI tmake_uint1(unsigned int x);
typedef uint2 HIPAPI tmake_uint2(unsigned int x, unsigned int y);
typedef uint3 HIPAPI tmake_uint3(unsigned int x, unsigned int y, unsigned int z);
typedef uint4 HIPAPI tmake_uint4(unsigned int x, unsigned int y, unsigned int z, unsigned int w);
typedef ulong1 HIPAPI tmake_ulong1(unsigned long x);
typedef ulong2 HIPAPI tmake_ulong2(unsigned long x, unsigned long y);
typedef ulong3 HIPAPI tmake_ulong3(unsigned long x, unsigned long y, unsigned long z);
typedef ulong4 HIPAPI tmake_ulong4(unsigned long x, unsigned long y, unsigned long z, unsigned long w);
typedef ulonglong1 HIPAPI tmake_ulonglong1(unsigned long long x);
typedef ulonglong2 HIPAPI tmake_ulonglong2(unsigned long long x, unsigned long long y);
typedef ulonglong3 HIPAPI tmake_ulonglong3(unsigned long long x, unsigned long long y, unsigned long long z);
typedef ulonglong4 HIPAPI tmake_ulonglong4(unsigned long long x, unsigned long long y, unsigned long long z, unsigned long long w);
typedef ushort1 HIPAPI tmake_ushort1(unsigned short x);
typedef ushort2 HIPAPI tmake_ushort2(unsigned short x, unsigned short y);
typedef ushort3 HIPAPI tmake_ushort3(unsigned short x, unsigned short y, unsigned short z);
typedef ushort4 HIPAPI tmake_ushort4(unsigned short x, unsigned short y, unsigned short z, unsigned short w);
...
extern tmake_char1 *make_char1;
extern tmake_char2 *make_char2;
extern tmake_char3 *make_char3;
extern tmake_char4 *make_char4;
extern tmake_double1 *make_double1;
extern tmake_double2 *make_double2;
extern tmake_double3 *make_double3;
extern tmake_double4 *make_double4;
extern tmake_float1 *make_float1;
extern tmake_float2 *make_float2;
extern tmake_float3 *make_float3;
extern tmake_float4 *make_float4;
extern tmake_hipExtent *make_hipExtent;
extern tmake_hipPitchedPtr *make_hipPitchedPtr;
extern tmake_hipPos *make_hipPos;
extern tmake_int1 *make_int1;
extern tmake_int2 *make_int2;
extern tmake_int3 *make_int3;
extern tmake_int4 *make_int4;
extern tmake_long1 *make_long1;
extern tmake_long2 *make_long2;
extern tmake_long3 *make_long3;
extern tmake_long4 *make_long4;
extern tmake_longlong1 *make_longlong1;
extern tmake_longlong2 *make_longlong2;
extern tmake_longlong3 *make_longlong3;
extern tmake_longlong4 *make_longlong4;
extern tmake_short1 *make_short1;
extern tmake_short2 *make_short2;
extern tmake_short3 *make_short3;
extern tmake_short4 *make_short4;
extern tmake_uchar1 *make_uchar1;
extern tmake_uchar2 *make_uchar2;
extern tmake_uchar3 *make_uchar3;
extern tmake_uchar4 *make_uchar4;
extern tmake_uint1 *make_uint1;
extern tmake_uint2 *make_uint2;
extern tmake_uint3 *make_uint3;
extern tmake_uint4 *make_uint4;
extern tmake_ulong1 *make_ulong1;
extern tmake_ulong2 *make_ulong2;
extern tmake_ulong3 *make_ulong3;
extern tmake_ulong4 *make_ulong4;
extern tmake_ulonglong1 *make_ulonglong1;
extern tmake_ulonglong2 *make_ulonglong2;
extern tmake_ulonglong3 *make_ulonglong3;
extern tmake_ulonglong4 *make_ulonglong4;
extern tmake_ushort1 *make_ushort1;
extern tmake_ushort2 *make_ushort2;
extern tmake_ushort3 *make_ushort3;
extern tmake_ushort4 *make_ushort4;
